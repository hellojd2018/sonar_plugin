...
public final class PmdRulesDefinition implements RulesDefinition {
  ...
  public void define(Context context) {
    NewRepository repository = context
      .createRepository(PmdConstants.REPOSITORY_KEY, "Java")
  ...
  static void extractRulesData(NewRepository repository, String xmlRulesFilePath, String htmlDescriptionFolder) {
    ...
    ruleLoader.load(repository, org.sonar.plugins.pmd.rule.PmdRulesDefinition.class.getResourceAsStream(xmlRulesFilePath), "UTF-8");
    ExternalDescriptionLoader.loadHtmlDescriptions(repository, htmlDescriptionFolder);
    PropertyFileLoader.loadNames(repository, org.sonar.plugins.pmd.rule.PmdRulesDefinition.class.getResourceAsStream("/org/sonar/l10n/pmd.properties"));
