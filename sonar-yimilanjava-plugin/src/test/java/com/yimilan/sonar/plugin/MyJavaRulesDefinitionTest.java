...
public class MyJavaRulesDefinitionTest {
    ...
    @Test
    public void test() {
        YimilanJavaRulesDefinition rulesDefinition = new YimilanJavaRulesDefinition();
        RulesDefinition.Context context = new RulesDefinition.Context();
        rulesDefinition.define(context);
        RulesDefinition.Repository repository = context.repository(YimilanJavaRulesDefinition.REPOSITORY_KEY);
